function get_refinement_lidcavity()
clc
clear all

%cellLevel = load("prediction_Re800");

%cellLevel = load("ML_prediction_lidcavity_Re800");
cellLevel = load("ML_alg_lidcavity_Re800");

EdgeFilename1 = "../output/mesh/lidcavity-800-1EdgeInfo.txt";
bcFile = "../output/mesh/lidcavity-800-1bc.txt";
...
vtkfile = '../output/paraview/lidcavityRe800-02.vtk';
%vtkfile = '../output/paraview/lidcavityRe800-01.vtk';
...
%% cycle 2
 EdgeFilename2 = "../output/mesh/lidcavity-800-2EdgeInfo.txt";
 bcFile = "../output/mesh/lidcavity-800-2bc.txt";
...
last_cycle_level_array = level_array;
 ...
 vtkfile = '../output/paraview/lidcavityRe800-03.vtk';
ele_sizeo = length(level_array);
fid = fopen(vtkfile, 'at');
if fid ~= -1
    %fprintf(fid, ...... whatever.....
...
%% cycle 3
 EdgeFilename = "../output/mesh/lidcavity-800-3EdgeInfo.txt";
 bcFile = "../output/mesh/lidcavity-800-3bc.txt";
...
last_cycle_level_array = level_array;
 ...
 vtkfile = '../output/paraview/lidcavityRe800-04.vtk';
ele_sizeo = length(level_array);
fid = fopen(vtkfile, 'at');
if fid ~= -1
    %fprintf(fid, ...... whatever.....
...
%% cycle 4
 ...
 EdgeFilename = "../output/mesh/lidcavity-800-4EdgeInfo.txt";
 bcFile = "../output/mesh/lidcavity-800-4bc.txt";
 [mesh_Edge,edge_face,IBC_edge] = getedgeinfo(EdgeFilename,bcFile);
  refine_level = 4;
  [ele_list,refine_flag]=get_refine_ele(level_array, refine_level,mesh_Edge,edge_face,IBC_edge);
...
vtkfile = '../output/paraview/lidcavityRe800-05.vtk';
ele_sizeo = length(level_array);
fid = fopen(vtkfile, 'at');
if fid ~= -1
    %fprintf(fid, ...... whatever.....
